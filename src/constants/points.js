...
export const POINTS_BY_COLOR = {
  ...
  atracciones_museos: [
    ...
    { id: "pab_guayasamin", name: "Pabellón Guayasamin", description: "Pabellón dedicado a la cultura Guayasamin", lat: -0.0030775, lng: -78.454844, color: "#ffc800", icon: "attractions", 
    ...
    { id: "planetario",name: "Planetario", description: "Planetario con proyección de estrellas", lat: -0.002893, lng: -78.4550475, color: "#ffc800", icon: "attractions", 
    ...
    { id: "museo_cacao", name: "Museo del cacao", description: "Museo dedicado al cacao y su historia", lat: -0.001614, lng: -78.4551451, color: "#ffc800", icon: "attractions", 
    ...
    { id: "legado_virtual", name: "Legado Virtual", description: "Experiencia virtual sobre el legado cultural", lat: -0.0026843, lng: -78.4552738, color: "#ffc800", icon: "attractions", 
    ...
    { id: "museo_cerveza", name: "Museo Cerveza Artesanal", description: "Descubre una experiencia sensorial única en el centro del planeta Adéntrate en el fascinante mundo de la cerveza artesanal y conoce su proceso de elaboración, desde los ingredientes ancestrales hasta los aromas y sabores inspirados en la riqueza natural del Ecuador", lat: -0.0017324, lng: -78.4545912, color: "#ffc800", icon: "attractions", 
      imagenes: imgs("14.MUSEO CERVEZA", ["IMG_8872.png", "IMG_8873.png", "IMG_8874.png", "IMG_8875.png", "IMG_8876.png", "IMG_8877.png", "IMG_8878.png", "IMG_8879.png", "IMG_8880.png", "IMG_8881.png", "IMG_8882.png", "IMG_8883.png", "IMG_8884.png", "IMG_8885.png", "IMG_8886.png", "IMG_8887.png", "IMG_8888.png", "IMG_8889.png", "Museo Cerveza.png"]) 
    },
    { id: "pabellon_francia", name: "Pabellón de Francia", description: "Pabellón dedicado a la cultura francesa", lat: -0.0031023, lng: -78.4550493, color: "#ffc800", icon: "attractions", 
  ...
  // Plazas
  plazas: [
    { id: "plaza_cultura", name: "Plaza Cultura", description: "Plaza de eventos culturales", lat: -0.0021539, lng: -78.4537988, color: "#2bb446", icon: "park" },
    { id: "plaza_central", name: "Plaza Central", description: "Plaza central del monumento", lat: -0.0021901, lng: -78.4546825, color: "#2bb446", icon: "park" },
