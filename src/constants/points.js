...
export const POINTS_BY_COLOR = {
  ...
  servicios: [
    ...
    { id: "Hotel_Mitad_del_Mundo", name: "Hotel Mitad del Mundo", description: "Hospédate en un hotel temático con experiencias únicas y una vista privilegiada al Monumento Ecuatorial.", lat: -0.0023893251437348707,  lng:  -78.45464746077039, color: "#041a78", icon: "/images/log-foot.PNG" , imagenes: imgs("18.HOTEL", ["HOTEL.png"]) },
  ],
  ...
  atracciones_museos: [
    ...
    { id: "pab_guayasamin", name: "Pabellón Guayasamin", description: "Admira reproducciones de las obras más representativas de Oswaldo Guayasamín, uno de los artistas ecuatorianos más importantes.", lat: -0.0030775, lng: -78.454844, color: "#ffc800", icon: "attractions", 
    ...
    { id: "planetario",name: "Planetario", description: "Viaja por el universo mediante proyecciones astronómicas que revelan constelaciones, planetas y fenómenos del espacio.", lat: -0.002893, lng: -78.4550475, color: "#ffc800", icon: "attractions", 
    ...
    { id: "museo_cacao", name: "Museo del cacao", description: "Recorre la historia del cacao ecuatoriano, desde sus orígenes ancestrales hasta su transformación en uno de los mejores chocolates del mundo.", lat: -0.001614, lng: -78.4551451, color: "#ffc800", icon: "attractions", 
    ...
    { id: "legado_virtual", name: "Legado Virtual", description: "Vive experiencias tecnológicas que muestran la historia, cultura y patrimonio del Ecuador mediante contenidos digitales.", lat: -0.0026843, lng: -78.4552738, color: "#ffc800", icon: "attractions", 
      imagenes: imgs("7.LEGADO VIERTUAL", ["IMG_8778.png", "IMG_8781.png", "IMG_8783.png", "IMG_8791.png", "Legado Virtual.png"]) 
    },
    { id: "experimento_huevo", name: "Experimento del Huevo", description: "Pon a prueba tu equilibrio y descubre curiosidades científicas relacionadas con la línea ecuatorial.", lat: -0.0021183, lng: -78.4550887, color: "#ffc800", icon: "attractions", 
    ...
    { id: "museo_cerveza", name: "Museo Cerveza Artesanal", description: "Aprende sobre el proceso de elaboración de la cerveza y la historia del monje franciscano que impulsó su producción durante la época colonial.", lat: -0.0017324, lng: -78.4545912, color: "#ffc800", icon: "attractions", 
    ...
    { id: "pabellon_francia", name: "Pabellón de Francia", description: "Conoce la expedición científica que ayudó a determinar la ubicación de la línea ecuatorial en el siglo XVIII.", lat: -0.0031023, lng: -78.4550493, color: "#ffc800", icon: "attractions", 
    ...
    { id: "pabellon_ecuador", name: "Pabellón Ecuador", description: "Descubre la diversidad cultural, turística y natural de las veinticuatro provincias del Ecuador en un solo espacio.", lat: -0.0029697, lng: -78.4552645, color: "#ffc800", icon: "attractions", 
    ...
    { id: "tiangues",name: "Tiangues", description: "Descubre un espacio inspirado en los antiguos mercados andinos de intercambio cultural y comercial.", lat: -0.002409, lng: -78.4545765, color: "#ffc800", icon: "attractions", 
    ...
    { id: "zona_llamas", name: "Zona de llamas", description: "Comparte con llamas andinas y conoce más sobre estos emblemáticos camélidos de los Andes.", lat: -0.0016606417341177837, lng: -78.4564242259298, color: "#ffc800", icon: "attractions", 
  ...
  restaurantes: [
    ...
    { id: "el_organico_star_coffee", name: "El Orgánico Star Coffee", description: "Cafetería especializada en café orgánico", lat: -0.0018819, lng: -78.4545454, color: "#583700", icon: "restaurant", menu: ["café orgánico", "tés", "smoothies"] },
  ...
  tiendas_artesanias: [
    ...
    { id: "tienda_pichincha", name: "Tienda Pichincha", description: "Encuentra artesanías, productos locales y propuestas de emprendedores de la provincia de Pichincha.", lat: -0.0019104, lng: -78.4550271, color: "#9c27b0", icon: "local_convenience_store", 
  ...
  // Plazas
  plazas: [
    { id: "plaza_cultura", name: "Plaza Cultural", description: "Disfruta presentaciones artísticas, actividades culturales y eventos especiales en un espacio abierto para todos.", lat: -0.0021539, lng: -78.4537988, color: "#2bb446", icon: "park" },
    { id: "plaza_central", name: "Plaza Central", description: "Encuentra el principal punto de encuentro de la Ciudad Mitad del Mundo y escenario de grandes eventos.", lat: -0.0021901, lng: -78.4546825, color: "#2bb446", icon: "park" },
