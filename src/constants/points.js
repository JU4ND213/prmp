export const POINTS_BY_COLOR = {
  ...
  // Baños
  banos: [
    { id: "bano", name: "Baño", description: "Lugar para hacer necesidades biológicas", lat: -0.002868, lng: -78.4540173, color: "#00e1ff", icon: "wc" },
  ...
  atracciones_museos: [
    ...
    { id: "museo_cerveza", name: "Museo Cerveza Artesanal", description: "Museo dedicado a la cerveza", lat: -0.0017324, lng: -78.4545912, color: "#ffc800", icon: "attractions" },
